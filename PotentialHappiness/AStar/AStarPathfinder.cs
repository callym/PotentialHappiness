...
namespace PotentialHappiness.AStar
{
	...
	public class AStarPathfinder
	{
		...
		const int nodeMultiplier = 100;
		readonly int kPreallocatedNodes = 4000 * nodeMultiplier;
		readonly int kPreallocatedMapSearchNodes = 1000 * nodeMultiplier;
		...
		public void Initialise(Map map)
		{
			...
			{
				MapSearchNode msn = new MapSearchNode(this, map);
